...
REASONING_PROMPTS = [
    {
        ...
        "prompt": "Answer the following questions, Adam lies a lot, he promised to return in 3 days time, after 9 days he hasn't return. How many days was he supposed to have return",
        # TODO: Provide the expected numerical answer
        "expected_answer": "9 - 3 = 6",
    ...
    },
    {
        ...
        "prompt": "Adam is from Borno, same as Usman. both hardly fulfil their promises. What could be their reason?",
        # TODO: Provide the logical conclusion
        "expected_answer": "Perhaps family problems",
        "description": "Basic syllogistic reasoning"
    },
    {
        "id": "business_calculation",
        # TODO: Create a multi-step percentage calculation problem
        "prompt": "If a man made 20% profit from car sales in 2023 and his profit is $100,000. In 2024, he lost 22% profit, how much did he make?",
        # TODO: Provide the calculated result
        "expected_answer": "$390,000", # (100,000 / 0.20) - ((100,00 / 0.20) * 0.22)
...
GENERATION_PROMPTS = [
    {
        ...
        "prompt": "Write a creative story about people lying ends up unsuccessful",
    ...
    },
    {
        ...
        "prompt": "Create an engaging market product description for a revolutionary water tracker for kids, reminds users about hydration time.",
    ...
    },
    {
        ...
        "prompt": "Write a humorous dialogue about two chefs arguing which sources is better with grilled fish",
