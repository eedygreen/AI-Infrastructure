...
def get_purchase_summary(user_id: str) -> Dict:
    ...
    return {
        ...
        "most_purchased_count": most_purchased_count,
    ...
    def __init__(self, model: OpenAIServerModel):
        ...
        def handle_purchase(user_id: str, action: str, fruit_name: str = None, quantity: int = None) -> str:
            ...
            if action == "buy" and fruit_name and quantity:
                ...
                return self.purchases.run(f"Get purchase summary for the user {user_id}")
...
def run_demo():
    ...
    if purchase_summary['most_purchased_fruit']:
        print(f"    - Most pruchased fruits: {purchase_summary['most_purchased_fruit']} ({purchase_summary['most_purchased_count']} units)")
