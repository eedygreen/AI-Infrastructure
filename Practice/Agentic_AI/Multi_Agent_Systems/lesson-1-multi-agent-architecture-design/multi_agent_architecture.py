...
def extended_uluru_exercise():
    ...
    edge_labels = {
        ...
        ("Translation Verification Agent", "Arrernte Language Specialist"): "Verified Translation",
        ("Translation Verification Agent", "Pitjantjatjara Language Specialist"): "Verified Translation"
    }
