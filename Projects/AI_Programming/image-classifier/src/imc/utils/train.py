...
from imc.config import LossFunction
from imc.utils import run_validation
import torch
...
def train_model(
    ...
    console.print(f"Starting training on device: {device}")
    console.print(f"Training for {epochs} epochs with learning rate {learning_rate}")
