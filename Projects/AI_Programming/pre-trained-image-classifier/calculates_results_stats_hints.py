...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_stats_dic['n_correct_breed']:
    ...
    pct_match = len(results_stats_dic['n_macth']) / len(results_stats_dic['n_images']) * 100
    ...
    pct_correct_dogs = 100 * len(results_stats_dic['n_correct_dogs']) / len(results_stats_dic['n_dogs_img'])
    ...
    pct_correct_breed = 100 * len(results_stats_dic['n_correct_breed']) / len(results_stats_dic['n_dogs_img'])
