...
def print_results(results_dic, results_stats_dic, model, 
    ...
    #          results_stats_dic
    #
    print("{:20}: {:3d}".format('N Dog Images', results_stats_dic['n_notdogs_img']))
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if results_dic[key][id] != 'NOT-A-DOG':
                print("Dog Image misclassified!")
            else:
                print("Dog Image is Classified as a-DOG")
