...
if __name__ == "__main__":
    test_audio = TestAudioModerationResult
    test_audio.test_has_all_required_fields()
    test_audio.test_field_types()
    test_audio.test_inherits_from_moderation_result()
    test_audio.test_all_fields_are_required()